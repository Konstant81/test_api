...
class Client(models.Model):
    ...
    code = models.CharField(validators=[code_validation])                            # Код мобильного оператора
...
class Send(models.Model):
    ...
    code = models.CharField(validators=[MinLengthValidator(limit_value=1), MaxLengthValidator(limit_value=3)])                            # Код мобильного оператора
